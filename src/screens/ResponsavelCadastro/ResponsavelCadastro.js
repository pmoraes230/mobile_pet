  ...
  return (
    ...
    >
      <View style={styles.card}>
        ...
        <Text style={styles.subtitulo}>Complete os dados abaixo para começar a cuidar do seu pet.</Text>
        ...
        <Text style={[styles.senhaRequisito, temMinimo8 && styles.requisitoAtivo]}>✓ Mínimo 8 caracteres</Text>
        <Text style={[styles.senhaRequisito, temMaiuscula && styles.requisitoAtivo]}>✓ Uma letra maiúscula</Text>
        <Text style={[styles.senhaRequisito, temNumero && styles.requisitoAtivo]}>✓ Um número</Text>
        <Text style={[styles.senhaRequisito, temSimbolo && styles.requisitoAtivo]}>✓ Um símbolo (@$%)</Text>
