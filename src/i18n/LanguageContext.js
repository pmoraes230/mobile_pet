...
const translations = {
  ...
  en: {
    ...
    'Consultas': 'Appointments',
    'Vacina': 'Vaccine',
    'Carteira de vacinação': 'Vaccination card',
    'NOVO': 'NEW',
    'Aplicação': 'Application',
    'Próxima Dose': 'Next Dose',
    'Novo Registro': 'New Record',
    'Insira os dados da vacinação abaixo.': 'Enter the vaccination details below.',
    'Nome da Vacina': 'Vaccine Name',
    'dd/mm/aaaa': 'dd/mm/yyyy',
    'SALVAR REGISTRO': 'SAVE RECORD',
    'Atenção': 'Attention',
    'Informe o nome da vacina.': 'Enter the vaccine name.',
    'Informe as datas no formato dd/mm/aaaa.': 'Enter dates in dd/mm/yyyy format.',
    'Não foi possível identificar este pet.': 'Could not identify this pet.',
    'Sucesso': 'Success',
    'Vacina cadastrada com sucesso.': 'Vaccine registered successfully.',
    'Não foi possível cadastrar a vacina.': 'Could not register the vaccine.',
    'Nenhuma vacina cadastrada.': 'No vaccine registered.',
    'Medicamento': 'Medication',
    'Sim': 'Yes',
    'Não': 'No',
